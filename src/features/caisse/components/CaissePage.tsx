...
import { QueueBlockedCard } from '@/features/pos/components/QueueBlockedCard';
import { posGate } from '@/features/pos/gate';
import { useRegister } from '@/features/pos/hooks/useRegister';
import { useTerminalLock } from '@/features/pos/hooks/useTerminalLock';
import { findRecord, isSessionClose, waitingBehind } from '@/features/pos/queue';
...
/**
 * The counter. Records go into this device's queue and the screen carries on: the only things that
