...
interface CheckoutDialogProps {
  ...
  /** What is being paid for, so the cashier can see it is the right table. */
  readonly title: string;
}

export function CheckoutDialog({ open, onOpenChange, title, ...form }: CheckoutDialogProps) {
  return (
...
function CheckoutForm({
  ...
  onConfirm,
  isConfirming,
}: Omit<CheckoutDialogProps, 'open' | 'onOpenChange' | 'title'>) {
