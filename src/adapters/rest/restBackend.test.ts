...
describe('the wire', () => {
      ...
      lines: [
        {
          ...
          line_total_millimes: 1_500,
          refunds_line_no: null,
        },
      ],
      subtotal_millimes: 1_500,
      discount_millimes: 0,
  ...
  it('reads an answer as camelCase, money included', async () => {
    ...
    const wireSale = {
      ...
      refunds_sale_id: null,
      payment_method: 'cash',
      subtotal_millimes: 12_500,
      discount_millimes: 500,
      ...
      lines: [
        {
          ...
          line_discount_millimes: 0,
          cart_discount_share_millimes: 500,
          line_total_millimes: 12_000,
          refunds_line_no: null,
          refunded_qty: 0,
          refunded_millimes: 0,
        },
      ...
      lines: [
        {
          ...
          cartDiscountShareMillimes: 500,
          lineTotalMillimes: 12_000,
          refundsLineNo: null,
          refundedQty: 0,
          refundedMillimes: 0,
        },
