...
export type WireProductAvailability = Schemas['ProductAvailability'];
export type WireStockAdjustment = Schemas['StockAdjustment'];
export type WireStockAdjustmentResult = Schemas['StockAdjustmentResult'];
export type WireCategory = Schemas['Category'];
export type WireCategoryCreate = Schemas['CategoryCreate'];
export type WireDiningTable = Schemas['DiningTable'];
export type WireDiningTableInput = Schemas['DiningTableInput'];
export type WireOpenOrder = Schemas['OpenOrder'];
export type WireTableBoardEntry = Schemas['TableBoardEntry'];
export type WireKitchenTicket = Schemas['KitchenTicket'];
export type WireRemovedAfterSentItem = Schemas['RemovedAfterSentItem'];
export type WireOrderItemAddRecord = Schemas['OrderItemAddRecord'];
export type WireOrderItemRemoveRecord = Schemas['OrderItemRemoveRecord'];
export type WireOrderSendRecord = Schemas['OrderSendRecord'];
export type WireOrderItemPrepareRecord = Schemas['OrderItemPrepareRecord'];
export type WireOrderCancelRecord = Schemas['OrderCancelRecord'];
export type WireOrderItemAddResult = Schemas['OrderItemAddResult'];
export type WireOrderWriteResult = Schemas['OrderWriteResult'];
export type WireOpenOrderChanges = Schemas['OpenOrderChanges'];
